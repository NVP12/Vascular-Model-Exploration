...
xml_path = 'P1_case1_.xml' # Or your vasculature/hello.xml if that's the one you modified
...
cam.elevation = -30
cam.distance = 5.0
cam.lookat = np.array([0.0, 0.0, 0.7]) # Adjust to view your scene well
...
while not glfw.window_should_close(window):
    ...
    if drone_body_id != -1 and drone_joint_dof_addr != -1:
        ...
        world_angular_velocity = g_desired_local_angular_velocity #drone_world_orientation_matrix @ g_desired_local_angular_velocity
